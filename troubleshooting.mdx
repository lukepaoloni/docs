...
- **The fix:** Ensure all price and weight columns contain only numbers (e.g., `9.99`, `1500`) or valid units/currency codes as described in the [Spreadsheet Reference](/csv-reference).
...
<AccordionGroup>
  <Accordion title="Invalid header: [column_name]">
    ...
    **Fix:** 
    ...
    3. Make sure the column name matches exactly what's in our [Spreadsheet Reference](/csv-reference).
    4. Remove any extra spaces before or after the header text.
    
    <!-- [Screenshot: Error message in context] -->
  </Accordion>
