...
```csv
Zone,Country Code,Country Name,Province,Postcode,City,Name,Description,Price,...
Europe,FR,France,*,*,*,Colissimo International,,15.00 EUR,...
Europe,DE,Germany,*,*,*,Colissimo International,,15.00 EUR,...
```
