...
<Steps>
  <Step title="Open MatrixRates from your Shopify admin">
...
<CardGroup>
  ...
  <Card title="Learn about the spreadsheet format" icon="file-text">
    See the [Spreadsheet Reference](/csv-reference) to understand what each column means and how to format your rates correctly.
  </Card>
</CardGroup>