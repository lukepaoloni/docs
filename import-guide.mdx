...
<Steps>
  ...
  <Step title="Upload and Preview">
    Click the **Upload and preview** button. The app will process your file and show you a preview of the rates to be imported.
  </Step>
  <Step title="Confirm Import">
    Once you've reviewed the preview, confirm the import. You will see a success message showing how many rates were imported.
  </Step>
</Steps>
