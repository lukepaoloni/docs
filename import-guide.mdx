...
<Note>
  **Postcode and City filters:** Any postcode or city restrictions configured in your spreadsheet will not be visible within the Shopify Admin shipping settings. These are delivered by a MatrixRates backend service. You must test these by proceeding to checkout on your store's frontend.
</Note>
